...
root = tk.Tk()
q = tksd.askfloat("Parametr 2 (Float)", "Введите параметр освещения(x):",
    parent=root, minvalue=0)
w = tksd.askfloat("Parametr 2 (Float)", "Введите параметр освещения(y):",
    parent=root, minvalue=0)
e = tksd.askfloat("Parametr 2 (Float)", "Введите параметр освещения(z):",
    parent=root, minvalue=0)
